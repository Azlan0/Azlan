...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Harisakhtar0/user-agents.txt').text
...
def crackfree(idf,pwv):
    ...
    "user-agent": "[FBAN/FB4A;FBAV/335.0.0.39.120;FBBV/292233352;FBDM/{density=2.0,width=720,height=1344};FBLC/en_GB;FBRV/296244047;FBCR/StarHub;FBMF/SANTIN Life Shine;FBBD/SANTIN Life Shine;FBPN/com.facebook.katana;FBDV/SANTIN Life Shine;FBSV/7.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
